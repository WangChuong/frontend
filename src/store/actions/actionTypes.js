const actionTypes = Object.freeze({
    ...
    FETCH_ALL_SUPPORTS_SUCCESS: 'FETCH_ALL_SUPPORTS_SUCCESS',
    FETCH_ALL_SUPPORTS_FAILED: 'FETCH_ALL_SUPPORTS_FAILED',

    SAVE_DETAIL_DOCTOR_SUCCESS: 'SAVE_DETAIL_DOCTOR_SUCCESS',
    SAVE_DETAIL_DOCTOR_FAILED: 'SAVE_DETAIL_DOCTOR_FAILED',

    SAVE_DETAIL_SUPPORT_SUCCESS: 'SAVE_DETAIL_SUPPORT_SUCCESS',
    SAVE_DETAIL_SUPPORT_FAILED: 'SAVE_DETAIL_SUPPORT_FAILED',
    ...
    FETCH_REQUIRED_SUPPORT_INFOR_START: 'FETCH_REQUIRED_SUPPORT_INFOR_START',
    FETCH_REQUIRED_SUPPORT_INFOR_FAILED: 'FETCH_REQUIRED_SUPPORT_INFOR_FAILED',
})
