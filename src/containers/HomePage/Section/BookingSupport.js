...
class BookingSupport extends Component {
    ...
    async componentDidUpdate(prevProps, prevState, snapshot) {
        ...
        if (this.props.dataTime !== prevProps.dataTime) {
            if (this.props.dataTime && !_.isEmpty(this.props.dataTime)) {
                let supportId = this.props.dataTime.supportId;
...
export default connect(mapStateToProps, mapDispatchToProps)(BookingSupport);
